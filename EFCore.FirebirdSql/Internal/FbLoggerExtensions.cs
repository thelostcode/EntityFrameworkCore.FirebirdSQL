...
namespace Microsoft.EntityFrameworkCore.Internal
{
    ...
    public static class FbLoggerExtensions
    {
        ...
        {
            var definition =  FbStrings.LogDefaultDecimalTypeColumn;
        ...
        public static void ByteIdentityColumnWarning(
            ...
            [NotNull] IProperty property)
        {
            var definition = FbStrings.LogByteIdentityColumn;
        ...
        public static void ForeignKeyFound(
            ...
            // No DiagnosticsSource events because these are purely design-time messages
            => FbStrings.LogFoundForeignKey.Log(diagnostics, foreignKeyName, tableName, principalTableName, onDeleteAction);
        ...
        public static void DefaultSchemaFound(
            ...
            // No DiagnosticsSource events because these are purely design-time messages
            => FbStrings.LogFoundDefaultSchema.Log(diagnostics, schemaName);
        ...
        public static void PrimaryKeyFound(
            ...
            [NotNull] string tableName)
            // No DiagnosticsSource events because these are purely design-time messages
            => FbStrings.LogFoundPrimaryKey.Log(diagnostics, primaryKeyName, tableName);
        ...
        public static void UniqueConstraintFound(
            ...
            [NotNull] string tableName)
            // No DiagnosticsSource events because these are purely design-time messages
            => FbStrings.LogFoundUniqueConstraint.Log(diagnostics, uniqueConstraintName, tableName);
        ...
        public static void IndexFound(
            ...
            bool unique)
            // No DiagnosticsSource events because these are purely design-time messages
            => FbStrings.LogFoundIndex.Log(diagnostics, indexName, tableName, unique);
        ...
        public static void ForeignKeyReferencesMissingPrincipalTableWarning(
            ...
            // No DiagnosticsSource events because these are purely design-time messages
            => FbStrings.LogPrincipalTableNotInSelectionSet.Log(diagnostics, foreignKeyName, tableName, principalTableName);
        ...
        public static void ForeignKeyPrincipalColumnMissingWarning(
            ...
            [NotNull] string principalTableName)
            // No DiagnosticsSource events because these are purely design-time messages
            => FbStrings.LogPrincipalColumnNotFound.Log(diagnostics, foreignKeyName, tableName, principalColumnName, principalTableName);
        ...
        public static void MissingSchemaWarning(
            ...
            // No DiagnosticsSource events because these are purely design-time messages
            => FbStrings.LogMissingSchema.Log(diagnostics, schemaName);
        ...
        public static void MissingTableWarning(
            ...
            [CanBeNull] string tableName)
            // No DiagnosticsSource events because these are purely design-time messages
            => FbStrings.LogMissingTable.Log(diagnostics, tableName);
        ...
        public static void TableFound(
            ...
            [NotNull] string tableName)
            // No DiagnosticsSource events because these are purely design-time messages
            => FbStrings.LogFoundTable.Log(diagnostics, tableName);
    }
}
